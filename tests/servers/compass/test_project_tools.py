...
async def test_init_project_handler_success(temp_workspace):
    ...
    args = {"name": "test-project", "projects_dir": temp_workspace}
...
async def test_init_project_handler_already_exists(temp_workspace):
    ...
    args = {"name": "existing-project", "projects_dir": temp_workspace}
...
async def test_list_projects_handler_with_projects(temp_workspace):
    ...
    await init_project_handler({"name": "project1", "projects_dir": temp_workspace})

    await init_project_handler({"name": "project2", "projects_dir": temp_workspace})
...
async def test_get_project_status_handler_not_found(temp_workspace):
    ...
    args = {"project_name": "nonexistent", "projects_dir": temp_workspace}
...
async def test_get_project_status_handler_new_project(temp_workspace):
    ...
    # Create project first
    await init_project_handler({"name": "new-project", "projects_dir": temp_workspace})

    args = {"project_name": "new-project", "projects_dir": temp_workspace}
...
async def test_get_project_status_handler_with_tasks(temp_workspace):
    ...
    await init_project_handler(
        {"name": "active-project", "projects_dir": temp_workspace}
    )
...
"""
    ...
    args = {"project_name": "active-project", "projects_dir": temp_workspace}
    ...
    assert result["exploration_tasks"][0]["completed"]
...
async def test_init_project_creates_proper_structure(temp_workspace):
    ...
    args = {"name": "complete-project", "projects_dir": temp_workspace}

    await init_project_handler(args)
