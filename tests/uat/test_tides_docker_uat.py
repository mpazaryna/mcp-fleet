...
import logging
from mcp_docker_client import MCPDockerClient, TIDES_SERVER, create_test_workspace
...
def test_tides_workflow_management():
    ...
    with MCPDockerClient(tides_config, debug=True) as client:
        ...
        expected_tools = [
            "create_tide", "list_tides", "flow_tide", 
            "save_tide_report", "export_all_tides"
        ]
        ...
        # Daily work tide
        daily_result = client.call_tool("create_tide", {
        ...
        weekly_result = client.call_tool("create_tide", {
        ...
        monthly_result = client.call_tool("create_tide", {
        ...
        print("\n🎬 Test 2: List all tides...")
        list_result = client.call_tool("list_tides", {
            "filter_type": "all",
            "include_stats": True
        })
        ...
        if "content" in list_result:
            ...
            assert "Weekly Creative Flow" in list_content, "Weekly tide not found in list" 
        ...
        work_flow = client.call_tool("flow_tide", {
        ...
        creative_flow = client.call_tool("flow_tide", {
        ...
        report_result = client.call_tool("save_tide_report", {
            "tide_name": "Daily Deep Work",
            "format": "json",
        ...
        print("\n🎬 Test 5: Export all tides...")
        export_result = client.call_tool("export_all_tides", {
            "format": "markdown",
            "include_statistics": True,
            "date_range": {
                "start": "2025-01-01",
        ...
        with open(tide_data_files[0], 'r') as f:
        ...
        # Filter by flow type
        work_tides = client.call_tool("list_tides", {
            "filter_type": "work",
            "include_stats": False
        })
        
        creative_tides = client.call_tool("list_tides", {
            "filter_type": "creative", 
            "include_stats": False
        })
        ...
        # Summary statistics
        print("\n📊 UAT Session Summary:")
        print(f"   🌊 Tides created: 3")
        print(f"   🌀 Flow sessions: 2") 
...
def test_tides_claude_integration():
    ...
    with MCPDockerClient(tides_config) as client:
        ...
        flow_result = client.call_tool("flow_tide", {
