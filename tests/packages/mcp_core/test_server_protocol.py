...
from mcp_core.types import MCPServerOptions, MCPServerConfig, MCPTool
...
class TestMCPServerProtocol:
    ...
    async def test_server_lists_tools(self):
        ...
        options = MCPServerOptions(
            ...
            handlers={
                "test_tool": mock_handler,
                "another_tool": mock_handler
            }
        )
