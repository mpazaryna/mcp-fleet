...
class ProjectMetadata(BaseModel):
    ...
    exploration_completed_date: Optional[str] = None
    exploration_completion_reason: Optional[str] = None
...
class ProjectManager:
    ...
    async def update_tasks_file(
        self, 
        exploration_tasks: List[Task], 
        next_action: str = "continue exploration"
    ) -> None:
...
"""
    ...
    async def check_exploration_completion(self) -> Dict[str, Any]:
        ...
        try:
            ...
            completed_tasks = [task for task in tasks_data.exploration_tasks if task.completed]
            ...
            return {
                ...
                "reason": "Sufficient exploration depth achieved" if is_complete else "More exploration needed"
            }
        except Exception:
            return {
                "is_complete": False,
