...
from src.exploration_tools import exploration_handlers, exploration_tools
from src.project_tools import project_handlers, project_tools
...
async def main() -> None:
    ...
    try:
        ...
        server_options = MCPServerOptions(
            server_info=server_config, tools=all_tools, handlers=all_handlers
        )
